...
from src.data_train import create_model, train_model, evaluate_model
from src.data_evaluation import plot_loss_curves, plot_lr_vs_loss, evaluate_predictions


def main():
    try:
        file_path = 'src/data/employee_attrition.csv'
